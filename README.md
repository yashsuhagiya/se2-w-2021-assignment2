...
* **FORK** the SE2W 2021 Assignment2.
...
Since option 1 is trivial, the below provided instructions are to help you work with the Dockerfile.
    ...
    * In the toplevel directory with the Dockefile, run 
        ...
        * ``docker run --user 1000:1000 --rm -it -v ./se2-w-2021-assignment2:/Source se_assignment:2  bash``   
...
```
### General Notes ###
* Solutions must be turned in no later than **11:59pm AOE, 15th of Dec 2021!** No late days or other excuses.
